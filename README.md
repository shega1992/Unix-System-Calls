...
This repository holds the source code for my versions of Unix system calls and library functions. The idea for the project is taken from **Linux Programming Interface** book(See Exercise 5-4, 5-7, 6-3, 8-2, 18-3, 18-5, 20-4) https://man7.org/tlpi/. I'm going to add new system calls and library functions in the future.
## How does it works?
...
## Tests directory
I attach a primitive program to each system call and library function to test it (there are a few exceptions).
## Footnotes
